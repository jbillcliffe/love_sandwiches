...
def update_selected_worksheet(data, worksheet):
    """
    Update worksheet passed to function with a new row
    """
...
def get_last_five_sales():
    """
    Collects columns of data from sales, getting most recent
    five rows per sandwich as a list of lists
    """
...
def calculate_stock_data(data):
    """
    Calculate average stock for each type, adding 10% to
    prevent understock
    """
...
def main():
    ...
    update_selected_worksheet(final_surplus_data, "surplus")
